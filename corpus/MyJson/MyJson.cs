...
public class MyJson
{
    ...
    public static IJsonNode Parse(string json,bool RemoveRN)
    {
        json = json.Replace("\n", "");
        json = json.Replace("\r", "");
        json = json.Replace("\\", "");
    ...
    public class JsonNode_ValueNumber : IJsonNode
    {
        ...
        public void Scan(MyJson.ScanObj scan)
        {
            ...
            else
            {
                if (number.Contains("E") || number.Contains("e"))
                {
                    ...
                    value = (decimal)double.Parse(number);
                }
                else
                {
        ...
        public static implicit operator ulong(JsonNode_ValueNumber m)
        {
            return (ulong)m.value;
        }
        public static implicit operator long(JsonNode_ValueNumber m)
        {
            return (long)m.value;
        }
